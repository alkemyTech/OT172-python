# Implementar el Python Operator para el grupo de universidades D
...
#Configurar el Python Operator para que ejecute las dos funciones que procese los 
#datos para las siguientes universidades:
...
def transformation(df):
    ...
    df.to_csv(f'{path}/files/ET_Univ_tecnologica_nacional.csv')
    return(df)
