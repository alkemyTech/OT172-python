...
def Conexion(**kwargs):
    ...
    try:
        ...
        ruta_sql = ruta_absoluta + "/include/univ_del_salvador.sql" 
        ...
        Dataframe.to_csv(ruta_absoluta + "/files/Uni_Salvador.csv", index=False, encoding="utf-8")
        logging.info("Dataframe Universidad del Salvador exportado a csv con exito.")
        return None
    except Exception as e:
        logging.error(e)
"""
Configuracion del DAG con 2 operadores de Python para la Universidad del Salvador"
"""
default_args = {
    'owner': 'airflow',
...
with DAG(
    'elt_university_Salvador',
    description = 'etl for group of universities B (Universidad del Salvador).',
