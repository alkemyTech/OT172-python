...
# The .sql file is opened and the text is saved in the query variable
        with open(f'{path}/include/'+'Univ_Nacional_de_Rio_Cuarto'+'.sql') as file:
            try:
...
def ET_function(**kwargs):
        ...
        df_t = transformation(df,'Univ_Nacional_de_Rio_Cuarto')
...
# Dag definition for the ETL process
with DAG('Univ_Nacional_de_Rio_Cuarto',
