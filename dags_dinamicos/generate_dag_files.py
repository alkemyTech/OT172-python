        ...
        for filename in os.listdir(config_filepath):
            ...
            for file in os.listdir(sql_files):
                ...
                for line in fileinput.input(new_filename, inplace=True):
                    ...
                    line= line.replace("### Template for creating customized dags files using the generate ", ' ')
                    line= line.replace("### dags function. The different configuration parameters are replaced by ", ' ')
                    line= line.replace("### what is set in the dag_config.json file, customizing each dag", ' ')
