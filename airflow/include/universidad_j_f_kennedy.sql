...
--
--      Se concluye que en la columna "nombres" el primero de ellos es firts name y
--      el ultimo es last name
SELECT
	...
	REVERSE(SPLIT_PART(REVERSE(ubaUk.nombres), '-', 1)) AS last_name,
