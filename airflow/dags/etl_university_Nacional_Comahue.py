...
def Conexion(**kwargs):
    ...
    try:
        ...
        ruta_sql = ruta_absoluta + "/include/univ_del_comahue.sql" 
        ...
        Dataframe.set_axis(['university', 'career', 'inscription_date', 'first_name', 'last_name', 'gender', 'age', 'postal_code', 'location', 'email'], axis = 'columns', inplace = True)
        Dataframe.to_csv(ruta_absoluta + "/files/Uni_Comahue.csv", index=False, encoding="utf-8")
        logging.info("Dataframe Universidad Nacional de Comahue exportado a csv con exito.")
        return None
    except Exception as e:
        logging.error(e)
"""
Configuracion del DAG con 2 operadores de Python para la Universidad Nacional de Comahue."
"""
default_args = {
    'owner': 'airflow',
...
with DAG(
    'elt_university_Comahue',
    description = 'etl for group of universities B (Universidad Nacional de Comahue).',
