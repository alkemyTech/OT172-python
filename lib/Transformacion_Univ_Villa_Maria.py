...
list1 = ['university', 'career', 'inscription_date', 'gender', 'age', 'location', 'email']
list2 = ['universidad', 'carrera', 'fecha_de_inscripcion', 'sexo', 'fecha_nacimiento', 'direccion', 'email']
